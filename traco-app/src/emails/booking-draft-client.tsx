...
export default function BookingDraftClientEmail({
  clientName,
  designerName,
  studioName,
  scheduledFormatted,
  ...
  return (
    <Html>
      <Head />
      <Preview>Recebemos sua solicitação de agendamento</Preview>
      <Body style={main}>
        <Container style={card}>
          ...
          <Section style={body}>
            ...
            <Text style={paragraph}>
              {designerName} vai revisar e confirmar em breve. Você receberá um novo email
              assim que seu horário for aprovado.
            </Text>
            <Section style={recap}>
            ...
            <Text style={paragraph}>
              Se precisar alterar ou cancelar, é só responder este email ou entrar em contato
              direto via WhatsApp com {designerName}.
            </Text>
          </Section>
